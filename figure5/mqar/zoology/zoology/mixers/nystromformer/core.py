...
def scaled_query_key_softmax(
    ...
    # NOTE: assume we have (N, S, hs) instead of (B, nh, S, hs), with N = B x nh
...
def blocksparse_attention(
    ...
    # NOTE: perhaps add functionality to pad qkv if sequence length is not divisible by block size?
