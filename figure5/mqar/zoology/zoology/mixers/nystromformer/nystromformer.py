...
class NystromAttention(Attention):
    # NOTE: update defaults for use_razavi_pinverse and inv_iterations
    def __init__(
        self,
        d_model: int,
        dropout: float = 0.0,
        ...
        **kwargs,
        ...
        # NOTE: should be able to not have to pass in num_heads
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.num_landmarks >= seq_len:
            ...
            kernel_1 = scaled_query_key_softmax(q=q, k=k_landmarks, att_mask=self.causal_mask_1)
