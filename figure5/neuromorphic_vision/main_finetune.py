...
def get_args_parser():
    ...
    parser.add_argument(
        "--data_path", required=True, type=str, help="path to the selected dataset"
    )
    ...
    parser.add_argument("--test_input_size", default=None, type=int, help="images test input size")
...
def main(args):
    ...
    if args.dataset == 'gesture':
        dataset_train = create_gesture_datasets(
            root=args.data_path,
            train=True,
        ...
        dataset_val = create_gesture_datasets(
            root=args.data_path,
            train=False,
            ds=1,
            dt=15 * 1000,
    ...
    if args.model_mode == "tem_attn":
        model = models_tem_attn.__dict__[args.model](num_classes=num_classes)
